...
Directory "fig2_sup1" corresponds to all data and codes related to the supplementary data of Fig.2 in the main text (current correlation of Ising model).
Directory "fig2_sup2" corresponds to all data and codes related to the supplementary data of Fig.2 in the main text (current correlation of XY/XYZ model).
Directory "fig3" corresponds to all data and codes related to the Fig.3 in the main text.
