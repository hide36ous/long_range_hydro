...
set key spacing 3.0
#set title '$\alpha=1.6$' at graph 1.0, 1.0
#unset label

set xlabel offset 28 ,2.5 
set xlabel "$t$"

set label '(a)' at graph 0.15,0.7
set label 'Trans. Ising' at graph 0.15,0.58
set label '$\alpha=1.6$' at graph 0.15,0.48
