...
set xtics 10
set ytics 0.02
set xrange [0:30]  # X軸の範囲を制限
set yrange [-0.005:0.07]

set key at graph 1.0, 0.7
set key spacing 3.0
#set title '$\alpha=1.8$' at graph 1.0, 1.0
#unset label

set xlabel offset 28 ,2.5 
set xlabel "$t$"

set label '(c)' at graph 0.18,0.7
set label 'XYZ' at graph 0.18,0.58
set label '$\alpha=1.8$' at graph 0.18,0.48
