...
plot 'ising/alp_1.3/fort.53' u ($1/(3**0.625)):(($5+0.00090)*(3**0.625)) w l lw 4 lc rgb "#CC79A7" title "$t=600$",\
     'ising/alp_1.3/fort.53' u ($1/(4**0.625)):(($6+0.00085)*(4**0.625)) w l lw 4 lc rgb "#56B4E9" title "$t=800$",\
     'ising/alp_1.3/fort.53' u ($1/(5**0.625)):(($7+0.00081)*(5**0.625)) w l lw 4 lc rgb "#009E73" title "$t=1000$",\
     'ising/alp_1.3/fort.53' u ($1/(6**0.625)):(($8+0.00077)*(6**0.625)) w l lw 4 lc rgb "#0072B2" title "$t=1200$",\
     'ising/alp_1.3/fort.53' u ($1/(7**0.625)):(($9+0.00071)*(7**0.625)) w l lw 4 lc rgb "#FF0000" title "$t=1400$"
...
set xrange [-290:290]
set yrange [-0.0003:0.0038]
plot 'ising/alp_1.3/fort.53' u 1:($5+0.00090) w l lw 4 lc rgb "#CC79A7" notitle,\
     'ising/alp_1.3/fort.53' u 1:($6+0.00085) w l lw 4 lc rgb "#56B4E9" notitle,\
     'ising/alp_1.3/fort.53' u 1:($7+0.00081) w l lw 4 lc rgb "#009E73" notitle,\
     'ising/alp_1.3/fort.53' u 1:($8+0.00077) w l lw 4 lc rgb "#0072B2" notitle,\
     'ising/alp_1.3/fort.53' u 1:($9+0.00071) w l lw 4 lc rgb "#FF0000" notitle
...
#set ytics 0.001
set mytics 1
plot 'xyz/alp_1.3/fort.53' u 1:5 w l lw 4 lc rgb "#CC79A7" notitle,\
     'xyz/alp_1.3/fort.53' u 1:6 w l lw 4 lc rgb "#56B4E9" notitle,\
     'xyz/alp_1.3/fort.53' u 1:7 w l lw 4 lc rgb "#009E73" notitle,\
     'xyz/alp_1.3/fort.53' u 1:8 w l lw 4 lc rgb "#0072B2" notitle,\
     'xyz/alp_1.3/fort.53' u 1:9 w l lw 4 lc rgb "#FF0000" notitle
...
plot 'ising/alp_1.6/fort.53' u 1:($5) w l lw 4 lc rgb "#CC79A7" notitle,\
     'ising/alp_1.6/fort.53' u 1:($6) w l lw 4 lc rgb "#56B4E9" notitle,\
     'ising/alp_1.6/fort.53' u 1:($7) w l lw 4 lc rgb "#009E73" notitle,\
     'ising/alp_1.6/fort.53' u 1:($8) w l lw 4 lc rgb "#0072B2" notitle,\
     'ising/alp_1.6/fort.53' u 1:($9) w l lw 4 lc rgb "#FF0000" notitle
...
set xrange [-290:290]
set yrange [-0.0007:0.0015]
plot 'xyz/alp_1.6/fort.53' u 1:($5) w l lw 4 lc rgb "#CC79A7" notitle,\
     'xyz/alp_1.6/fort.53' u 1:($6) w l lw 4 lc rgb "#56B4E9" notitle,\
     'xyz/alp_1.6/fort.53' u 1:($7) w l lw 4 lc rgb "#009E73" notitle,\
     'xyz/alp_1.6/fort.53' u 1:($8) w l lw 4 lc rgb "#0072B2" notitle,\
     'xyz/alp_1.6/fort.53' u 1:($9) w l lw 4 lc rgb "#FF0000" notitle
