...
set xrange [-290:290]
set yrange [-0.0002:0.0033]
plot 'xy/alp_1.1/fort.53' u 1:($5+0.00053) w l lw 4 lc rgb "#CC79A7" notitle,\
     'xy/alp_1.1/fort.53' u 1:($6+0.00053) w l lw 4 lc rgb "#56B4E9" notitle,\
     'xy/alp_1.1/fort.53' u 1:($7+0.00053) w l lw 4 lc rgb "#009E73" notitle,\
     'xy/alp_1.1/fort.53' u 1:($8+0.00053) w l lw 4 lc rgb "#0072B2" notitle,\
     'xy/alp_1.1/fort.53' u 1:($9+0.00053) w l lw 4 lc rgb "#FF0000" notitle
...
set xrange [-290:290]
set yrange [-0.0002:0.0024]
#set ytics 0.001
set mytics 1
plot 'xy/alp_1.3/fort.53' u 1:($5+0.00046) w l lw 4 lc rgb "#CC79A7" notitle,\
     'xy/alp_1.3/fort.53' u 1:($6+0.00046) w l lw 4 lc rgb "#56B4E9" notitle,\
     'xy/alp_1.3/fort.53' u 1:($7+0.00046) w l lw 4 lc rgb "#009E73" notitle,\
     'xy/alp_1.3/fort.53' u 1:($8+0.00046) w l lw 4 lc rgb "#0072B2" notitle,\
     'xy/alp_1.3/fort.53' u 1:($8+0.00046) w l lw 4 lc rgb "#FF0000" notitle
...
set xrange [-140:140]
set yrange [-0.0003:0.0041]
plot 'xy/alp_1.6/fort.53' u ($1/(3**0.5)):(($5+0.00042)*(3**0.5)) w l lw 4 lc rgb "#CC79A7" title "$t=1200$", \
     'xy/alp_1.6/fort.53' u ($1/(4**0.5)):(($6+0.00042)*(4**0.5)) w l lw 4 lc rgb "#56B4E9" title "$t=1600$", \
     'xy/alp_1.6/fort.53' u ($1/(5**0.5)):(($7+0.00042)*(5**0.5)) w l lw 4 lc rgb "#009E73" title "$t=2000$", \
     'xy/alp_1.6/fort.53' u ($1/(6**0.5)):(($8+0.00042)*(6**0.5)) w l lw 4 lc rgb "#0072B2" title "$t=2400$", \
     'xy/alp_1.6/fort.53' u ($1/(7**0.5)):(($9+0.00042)*(7**0.5)) w l lw 4 lc rgb "#FF0000" title "$t=2800$"
...
#set ytics 0.001
set mytics 1
plot 'xy/alp_1.6/fort.53' u 1:($5+0.00042) w l lw 4 lc rgb "#CC79A7" notitle,\
     'xy/alp_1.6/fort.53' u 1:($6+0.00042) w l lw 4 lc rgb "#56B4E9" notitle,\
     'xy/alp_1.6/fort.53' u 1:($7+0.00042) w l lw 4 lc rgb "#009E73" notitle,\
     'xy/alp_1.6/fort.53' u 1:($8+0.00042) w l lw 4 lc rgb "#0072B2" notitle,\
     'xy/alp_1.6/fort.53' u 1:($9+0.00042) w l lw 4 lc rgb "#FF0000" notitle
